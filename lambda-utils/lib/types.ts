...
export type APIGatewayProxyEventAnyVersion =
  | AWS_APIGatewayProxyEvent
  | APIGatewayProxyEvent
  | AWS_APIGatewayProxyEventV2
...
export type AsyncProxyHandlerV1 = (
...
export type AsyncMiddyifedHandlerV1 = middy.MiddyfiedHandler<
  AWS_APIGatewayProxyEvent,
  APIGatewayProxyResult | object | void
>;

/** LambdaUtils version of ProxyHandler for API Gateway v2 payload format */
export type AsyncProxyHandlerV2 = (
  event: APIGatewayProxyEventV2,
  context: Context,
  callback?: Callback<APIGatewayProxyStructuredResultV2>,
) => Promise<APIGatewayProxyStructuredResultV2 | object | void>;
/** LambdaUtils version of an API Gateway v2 payload handler wrapped with middy */
export type AsyncMiddyifedHandlerV2 = middy.MiddyfiedHandler<
  AWS_APIGatewayProxyEventV2,
  APIGatewayProxyStructuredResultV2 | object | void
>;
